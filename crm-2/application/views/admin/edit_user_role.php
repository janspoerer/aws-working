...
<div class="row">
<div class="col-md-6">
<strong><?php echo lang("ctn_1306") ?></strong><br /><br />
...
<div class="col-md-6"><strong><?php echo lang("ctn_1307") ?></strong><br /><br />
...
<p class="small-text"><?php echo lang("ctn_1308") ?></p>
...
<hr>
<input type="submit" class="btn btn-primary" value="<?php echo lang("ctn_1309") ?>">
<?php echo form_close() ?>
