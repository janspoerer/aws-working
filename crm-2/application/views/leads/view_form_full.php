...
<?php if(!isset($project_data->hash)) : ?>
 <div class="alert alert-danger"><b><span class="glyphicon glyphicon-remove-circle"></span></b> <?php echo lang("ctn_2004") ?></div>
<?php endif; ?>

<?php echo form_open(site_url("leads/process_form/" . $form->ID . "/1"), array("class" => "form-horizontal")) ?>
<p><?php echo $form->welcome ?></p>
<hr>
<?php if($form->collect_user && isset($project_data->hash)) : ?>
...
<!-- Added by Clemens -->
<input type="hidden" name="hash" value="<?php if(isset($project_data->hash)) echo $project_data->hash; ?>"/>
