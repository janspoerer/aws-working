...
class Home extends CI_Controller 
{
	...
	public function index()
	{
		...
		$this->template->loadContent("home/index.php", array(
			...
			"task_model" => $this->task_model, // Added by Malte
			"projects_by_due_date" => $this->projects_model->get_user_projects_by_due_date($this->user->info->ID)
			//"projects_by_due_date" => $this->projects_model->get_projects_user_all_no_pagination($this->user->info->ID, "")
			//"projects_by_due_date" => $client_projects
			)
		);
	}
