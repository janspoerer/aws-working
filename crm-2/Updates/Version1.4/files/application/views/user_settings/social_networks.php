...
<div class="db-header clearfix">
    ...
    <div class="db-header-extra"> <a href="<?php echo site_url("user_settings/change_password") ?>" class="btn btn-primary btn-sm"><?php echo lang("ctn_225") ?></a> <a href="<?php echo site_url("user_settings/social_networks") ?>" class="btn btn-info btn-sm"><?php echo lang("ctn_1387") ?></a>
</div>
</div>
...
<ol class="breadcrumb">
  ...
  <li class="active"><?php echo lang("ctn_1387") ?></li>
</ol>
