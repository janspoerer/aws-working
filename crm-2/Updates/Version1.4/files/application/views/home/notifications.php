...
<div class="db-header clearfix">
    <div class="page-header-title"> <span class="glyphicon glyphicon-bell"></span> <?php echo lang("ctn_581") ?></div>
...
<span class="glyphicon glyphicon-search" aria-hidden="true"></span></button>
        <ul class="dropdown-menu small-text" style="min-width: 90px !important; left: -90px;">
          ...
          <li><a href="#" onclick="change_search(3)"><span class="glyphicon glyphicon-ok no-display" id="message-exact"></span> <?php echo lang("ctn_582") ?></a></li>
        </ul>
      </div><!-- /btn-group -->
</div>
</div>

<a href="<?php echo site_url("home/read_all_noti/" . $this->security->get_csrf_hash()) ?>" class="btn btn-primary btn-sm">Mark All Read</a>
...
<thead>
<tr class="table-header"><td><?php echo lang("ctn_357") ?></td><td><?php echo lang("ctn_582") ?></td><td><?php echo lang("ctn_583") ?></td><td><?php echo lang("ctn_52") ?></td></tr>
</thead>
<tbody>
</tbody>
</table>
