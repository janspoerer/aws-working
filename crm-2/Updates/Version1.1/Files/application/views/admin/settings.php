...
<div class="form-group">
    <label for="dpname-in" class="col-sm-2 control-label">Enable Secure Login</label>
    <div class="col-sm-10">
        <input type="checkbox" name="secure_login" value="1" <?php if($this->settings->info->secure_login) echo "checked" ?> />
        <span class="help-block">When this option is enabled, each time a user logs in their "login-token" is refreshed, making old ones invalid. This prevents multiple people from logging into the same account.</span>
    </div>
</div>
