...
<div class="form-group">
    <label for="name-in" class="col-sm-2 control-label"><?php echo lang("ctn_1178") ?></label>
    <div class="col-sm-10">
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        <input type="text" name="checkout2_accountno" class="form-control" value="<?php echo $invoice->checkout2_accountno ?>" />
    </div>
</div>
<div class="form-group">
    <label for="name-in" class="col-sm-2 control-label"><?php echo lang("ctn_1184") ?></label>
    <div class="col-sm-10">
        <input type="text" name="checkout2_secret" class="form-control" value="<?php echo $invoice->checkout2_secret ?>" />
    </div>
</div>
