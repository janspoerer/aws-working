...
<hr>
            ...
            <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="checkbox" name="services_manage" value="1" <?php if($role->services_manage) echo "checked" ?>>
                        </div>
            </div>
            </div>
            <div class="col-md-6">
            ...
            <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="checkbox" name="project_client" value="1" <?php if($role->project_client) echo "selected" ?>>
                        </div>
            </div>
            <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="checkbox" name="task_client" value="1" <?php if($role->task_client) echo "selected" ?>>
                        </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="checkbox" name="reports_manage" value="1" <?php if($role->reports_manage) echo "checked" ?>>
                        </div>
            </div>
            <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="checkbox" name="reports_worker" value="1" <?php if($role->reports_worker) echo "checked" ?>>
                        </div>
            </div>
            </div>
            </div>
