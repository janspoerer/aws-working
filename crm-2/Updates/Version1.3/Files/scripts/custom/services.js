...
function add_form_field() 
{
	...
	var html = '<div id="field-area-'+newid+'" class="field-area">'
				...
				+'<div class="form-group">'
				        ...
				        +'</div>'
				        +'<div class="col-md-4 ui-front">'
				          +'<input type="text" name="field_cost_'+newid+'" id="field_cost_'+newid+'" class="form-control" placeholder="+Additional Cost ... 0.00">'
				        +'</div>'
				+'</div>'
				+'<button type="button" onclick="remove_field('+newid+')" class="btn btn-danger btn-sm">Remove</button>'
				+'</div>';
	$('#fields').append(html);
