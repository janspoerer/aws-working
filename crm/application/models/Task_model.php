...
class Task_Model extends CI_Model 
{
	...
	public function update_user_lead_answer($leadid, $fieldid, $answer) {
		$this->db
			->where("fieldid", $fieldid)
			->where("leadid", $leadid)
			->update("user_lead_fields", ["answer" => $answer]);
