...
<div class="db-header clearfix">
    ...
    <div class="db-header-extra"> <a href="<?php echo site_url("admin/edit_member/" . $member->ID) ?>" class="btn btn-warning btn-sm">Edit Member</a> <input type="button" class="btn btn-primary btn-sm" value="Add To User Group" data-toggle="modal" data-target="#addModal" />
</div>
</div>
...
<tr class="table-header"><td><?php echo lang("ctn_1272") ?></td><td><?php echo lang("ctn_52") ?></td></tr>
    ...
    <div class="modal-content">
      ...
      <?php echo form_open(site_url("admin/add_member_to_group_pro/" . $member->ID), array("class" => "form-horizontal")) ?>
            <div class="form-group">
                    <label for="email-in" class="col-md-3 label-heading"><?php echo lang("ctn_1272") ?></label>
                    <div class="col-md-9">
