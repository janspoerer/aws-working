...
class Projects extends CI_Controller 
{
	...
	public function projects_page($page = "index", $catid) 
	{
		...
		foreach($projects->result() as $r) {
    		...
    		$options = '<a href="'.site_url("projects/make_active/" . $r->ID).'" class="btn btn-primary btn-xs" data-toggle="tooltip" data-placement="bottom" title="'.lang("ctn_788").'"><span class="glyphicon glyphicon-pushpin"></span></a> ';
