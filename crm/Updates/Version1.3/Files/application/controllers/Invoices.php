...
class Invoices extends CI_Controller 
{
	...
	public function add_pro() 
	{
		...
		$paypal = intval($this->input->post("paypal"));
		...
		$checkout2 = intval($this->input->post("checkout2"));
	...
	public function view($id, $hash) 
	{
		...
		if($invoice->checkout2 == 0) {
			...
			$checkout2 = array(
				"accountno" => $invoice->checkout2_accountno,
				"secret" => $invoice->checkout2_secret
			);
		}
		...
		if($invoice->paypal == 0) {
			...
			$paypal_email = $invoice->user_paypal_email;
		}
