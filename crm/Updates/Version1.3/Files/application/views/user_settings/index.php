...
<?php echo form_open_multipart(site_url("user_settings/pro"), array("class" => "form-horizontal")) ?>
	...
	<?php endif; ?>
	<?php if($invoice->enable_checkout2) : ?>
		<h3><?php echo lang("ctn_1181") ?></h3>
		<p><?php echo lang("ctn_1220") ?></p>
		<div class="form-group">
	    <label for="name-in" class="col-sm-2 control-label"><?php echo lang("ctn_1183") ?></label>
	    <div class="col-sm-10">
	        <input type="text" name="checkout2_accountno" class="form-control" value="<?php echo $this->user->info->checkout2_accountno ?>" />
	    </div>
	</div>
	<div class="form-group">
	    <label for="name-in" class="col-sm-2 control-label"><?php echo lang("ctn_1184") ?></label>
	    <div class="col-sm-10">
	        <input type="text" name="checkout2_secret" class="form-control" value="<?php echo $this->user->info->checkout2_secret ?>" />
	    </div>
	</div>
	<?php endif; ?>
