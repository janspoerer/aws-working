...
<div class="form-group">
        ...
        <div class="col-md-8">
            ...
            <option value="1" <?php if($invoice->paypal == 1) echo "selected" ?>><?php echo lang("ctn_1209") ?></option>
            </select>
...
<div class="form-group">
        ...
        <div class="col-md-8">
            ...
            <option value="1" <?php if($invoice->checkout2 == 1) echo "selected" ?>><?php echo lang("ctn_1211") ?></option>
            </select>
