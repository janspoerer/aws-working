...
<td>
  ...
  <?php if($r->reports_manage) : ?><span class="user_role_button project" title="<?php echo lang("ctn_1143") ?>" data-placement="bottom" data-toggle="tooltip"><?php echo lang("ctn_1142") ?></span><?php endif; ?>
  <?php if($r->reports_worker) : ?><span class="user_role_button project" title="<?php echo lang("ctn_1145") ?>" data-placement="bottom" data-toggle="tooltip"><?php echo lang("ctn_1144") ?></span><?php endif; ?>
  ...
  <?php if($r->project_client) : ?><span class="user_role_button client" title="<?php echo lang("ctn_1186") ?>" data-placement="bottom" data-toggle="tooltip"><?php echo lang("ctn_1185") ?></span><?php endif; ?>
   <?php if($r->task_client) : ?><span class="user_role_button client" title="<?php echo lang("ctn_1188") ?>" data-placement="bottom" data-toggle="tooltip"><?php echo lang("ctn_1187") ?></span><?php endif; ?>
     <?php if($r->services_manage) : ?><span class="user_role_button project" title="<?php echo lang("ctn_1190") ?>" data-placement="bottom" data-toggle="tooltip"><?php echo lang("ctn_1189") ?></span><?php endif; ?>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <?php echo form_open(site_url("admin/add_user_role_pro"), array("class" => "form-horizontal")) ?>
            ...
            <div class="form-group">
                        <label for="username-in" class="col-md-8 label-heading"><?php echo lang("ctn_1189") ?> <span class="glyphicon glyphicon-question-sign" title="<?php echo lang("ctn_1190") ?>" data-toggle="tooltip" data-placement="bottom"></span></label>
                        <div class="col-md-4">
                            <input type="checkbox" name="services_manage" value="1">
                        </div>
            </div>
            </div>
            <div class="col-md-6">
            ...
            <div class="form-group">
                        <label for="username-in" class="col-md-8 label-heading"><?php echo lang("ctn_1185") ?> <span class="glyphicon glyphicon-question-sign" title="<?php echo lang("ctn_1186") ?>" data-toggle="tooltip" data-placement="bottom"></span></label>
                        <div class="col-md-4">
                            <input type="checkbox" name="project_client" value="1">
                        </div>
            </div>
            <div class="form-group">
                        <label for="username-in" class="col-md-8 label-heading"><?php echo lang("ctn_1187") ?> <span class="glyphicon glyphicon-question-sign" title="<?php echo lang("ctn_1188") ?>" data-toggle="tooltip" data-placement="bottom"></span></label>
                        <div class="col-md-4">
                            <input type="checkbox" name="task_client" value="1">
                        </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                        <label for="username-in" class="col-md-8 label-heading"><?php echo lang("ctn_1142") ?> <span class="glyphicon glyphicon-question-sign" title="<?php echo lang("ctn_1143") ?>" data-toggle="tooltip" data-placement="bottom"></span></label>
                        <div class="col-md-4">
                            <input type="checkbox" name="reports_manage" value="1">
                        </div>
            </div>
            <div class="form-group">
                        <label for="username-in" class="col-md-8 label-heading"><?php echo lang("ctn_1144") ?> <span class="glyphicon glyphicon-question-sign" title="<?php echo lang("ctn_1145") ?>" data-toggle="tooltip" data-placement="bottom"></span></label>
                        <div class="col-md-4">
                            <input type="checkbox" name="reports_worker" value="1">
                        </div>
            </div>
            </div>
            </div>
